  ...
  >
    ...
    >
      ...
      <div class="text-center mb-10">
        ...
        <h1 class="text-4xl font-black tracking-tight bg-gradient-to-r from-interview-text-primary via-white to-interview-text-secondary bg-clip-text text-transparent drop-shadow-2xl mb-2">
          HR Portal
        </h1>
